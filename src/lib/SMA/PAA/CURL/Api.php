...
final class Api implements IApi
{
    ...
    public function getWithAuthorizationKey(string $authorizationKey, string $path)
    {
        return $this->call("get", "", $authorizationKey, $path, []);
    }
    public function deleteWithAuthorizationKey(string $authorizationKey, string $path, array $values)
    {
        return $this->call("delete", "", $authorizationKey, $path, $values);
    }
}
